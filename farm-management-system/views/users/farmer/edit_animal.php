<!-- 
    NOTE TO CONTRIBUTORS: Do not edit this file directly.

    This file is part of the Farm Management System and is managed by Brian 
    Any changes made directly to this file may be overwritten or cause unexpected behavior in the application.

    If you need to update the layout, styles, or PHP logic, please contact the project maintainer or submit a pull request
    with your proposed changes. For minor fixes, refer to the documentation or reach out via the official communication channels.
            ...
            <div class="form-container">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="view_animal.php?id=<?php echo $animal['id']; ?>" class="btn btn-secondary">
                            <span>↩️</span>
                            <span>Cancel</span>
                        </a>
